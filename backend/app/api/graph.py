...
def build_graph():
    """
    Interface 2: Build graph from project_id
    ...
    try:
        ...
        if project.status == ProjectStatus.GRAPH_BUILDING and not force:
            return jsonify({
                "success": False,
                "error": "Graph is already building, do not submit again. To force rebuild, add force: true",
        ...
        return jsonify({
            ...
            "data": {
                "project_id": project_id,
                "task_id": task_id,
                "message": "Graph build task started, query progress at /task/{task_id}"
            }
        })
