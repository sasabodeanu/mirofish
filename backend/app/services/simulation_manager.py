...
class SimulationManager:
    ...
    3. Use LLM to intelligently generate simulation parameters
    ...
    def prepare_simulation(
        ...
        3. Use LLM to intelligently generate simulation parameters (time, activity level, post frequency, etc.)
        ...
        try:
            ...
            if progress_callback:
                progress_callback(
                    ...
                    f"Complete, {len(profiles)} profiles",
                    current=len(profiles),
                    total=len(profiles)
                )
            
            # ========== Phase 3: LLM-generated simulation configuration ==========
            if progress_callback:
                progress_callback(
                    "generating_config", 0, 
            ...
            # Note: run scripts remain in backend/scripts/ directory, not copied to simulation directory
