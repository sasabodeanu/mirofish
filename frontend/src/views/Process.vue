      ...
      <div class="left-panel" :class="{ 'full-screen': isFullScreen }">
        ...
        <div class="graph-container" ref="graphContainer">
          ...
          <div v-else-if="currentPhase < 1" class="graph-waiting">
            ...
            <p class="waiting-hint">Graph build will start automatically once ontology is ready</p>
          </div>
            ...
            <div class="phase-detail">
              <div class="detail-section">
                ...
                <div class="detail-content">
                  After uploading documents, the LLM analyzes the content and automatically generates an ontology structure (entity types + relation types) suitable for public opinion simulation
                </div>
              </div>
          ...
          <div class="process-phase" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
            ...
            <div class="phase-detail">
              <div class="detail-section">
                <div class="detail-label">API Description</div>
                <div class="detail-content">
                  Based on the generated ontology, the documents are chunked and processed through the Zep API to build a knowledge graph, extracting entities and relations
                </div>
              </div>
...
const loadProject = async () => {
  try {
    ...
    if (response.success) {
      ...
      // Continue polling the building task
...
const fetchGraphData = async () => {
  try {
    // Fetch project info first to get graph_id
...
const renderGraph = () => {
  ...
  // Create node ID set for valid edge filtering
