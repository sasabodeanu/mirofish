...
Persists project state server-side to avoid passing large data between API calls
"""
...
class Project:
    ...
    # Ontology information (populated after interface 1)
    ontology: Optional[Dict[str, Any]] = None
    analysis_summary: Optional[str] = None
    
    # Graph information (populated after interface 2)
...
class ProjectManager:
    ...
    def _get_project_text_path(cls, project_id: str) -> str:
        """Get path for storing extracted project text"""
