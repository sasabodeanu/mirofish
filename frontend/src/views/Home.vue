    ...
    <div class="main-content">
      ...
      <section class="hero-section">
        <div class="hero-left">
          ...
          <div class="hero-desc">
            <p>
              Even from a single paragraph, <span class="highlight-bold">MiroFish</span> can automatically generate a parallel world of up to <span class="highlight-orange">millions of Agents</span> based on the reality seeds within. Inject variables from a god's-eye view and discover the <span class="highlight-code">"local optimum"</span>
            </p>
            <p class="slogan-text">
              Let the future rehearse among Agents — let decisions emerge victorious through battle-tested simulations<span class="blinking-cursor">_</span>
            </p>
          </div>
      ...
      <section class="dashboard-section">
        ...
        <div class="left-panel">
          ...
          <p class="section-desc">
            Prediction engine on standby. Upload unstructured data files to initialize the simulation sequence.
          </p>
            ...
            <div class="workflow-list">
              ...
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Entity-relation extraction & persona generation & Agent parameter injection</div>
                </div>
              </div>
              <div class="workflow-item">
            ...
            <div class="console-section">
              ...
              <div class="input-wrapper">
                <textarea
                  ...
                  class="code-input"
                  placeholder="// Describe your simulation or prediction goal in natural language (e.g. If Wuhan University announces the revocation of Xiao's disciplinary action, what public sentiment trend would emerge?)"
                  rows="6"
                  :disabled="loading"
                ></textarea>
...
const startSimulation = () => {
  ...
  import('../store/pendingUpload.js').then(({ setPendingUpload }) => {
    ...
    // Immediately navigate to the Process page (using special identifier for new project)
    router.push({
      name: 'Process',
