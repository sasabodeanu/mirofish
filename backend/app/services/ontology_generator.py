...
**Hierarchical requirement (must include both specific types and fallback types)**:

Your 10 entity types must include the following levels:

A. **Fallback types (must be included, placed as the last 2 in the list)**:
   - `Person`: Fallback type for any individual person. Used when a person does not fit any more specific person type.
...
B. **Specific types (8, designed based on text content)**:
   ...
   - Example: if the text involves commercial events, you can have `Company`, `CEO`, `Employee`

**Why fallback types are needed**:
- Text may contain various characters, e.g. "primary school teacher", "passerby", "some netizen"
...
- description must clearly explain the difference between this type and the fallback types

### 2. Relationship Type Design

- Quantity: 6-10
- Relationships should reflect real-world connections in social media interactions
- Ensure the relationship source_targets cover the entity types you have defined
...
4. All entity types must be real-world actors capable of speaking; no abstract concepts
...
"""
    ...
    def _validate_and_process(self, result: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # Final check to ensure within limits (defensive programming)
