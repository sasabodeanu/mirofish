...
// Fetch maxRounds from query params at init time to ensure child components get the value immediately
...
const loadGraph = async (graphId) => {
  // During simulation, auto-refresh does not show full-screen loading to avoid flickering
...
const startGraphRefresh = () => {
  ...
  addLog('Graph real-time refresh enabled (30s interval)')
...
onMounted(() => {
  ...
  // Log the maxRounds config (already fetched from query params at init)
  if (maxRounds.value) {
