...
def generate_report():
    ...
    This is a time-consuming operation; endpoint returns task_id immediately.
    ...
    try:
        ...
        return jsonify({
            ...
            "data": {
                ...
                "task_id": task_id,
                "status": "generating",
                "message": "Report generation task started, query progress at /api/report/generate/status",
...
def check_report_status(simulation_id: str):
    ...
    try:
        ...
        # Only unlock interview after report is complete
...
def get_agent_log(report_id: str):
    ...
    Retrieve step-by-step actions during report generation in real time, including:
...
def get_console_log(report_id: str):
    ...
    Retrieve console output during report generation in real time (INFO, WARNING, etc.).
