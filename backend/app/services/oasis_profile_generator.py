...
class OasisAgentProfile:
    ...
    def to_reddit_format(self) -> Dict[str, Any]:
        ...
        # Add extra persona info (if present)
        if self.age:
...
class OasisProfileGenerator:
    ...
    Converts entities from the Zep graph into Agent Profiles needed for OASIS simulation
    ...
    def __init__(
        ...
        # Zep client for context enrichment retrieval
    ...
    def _search_zep_for_entity(self, entity: EntityNode) -> Dict[str, Any]:
        ...
        Zep does not have a built-in hybrid search interface; edges and nodes must be searched separately and merged.
        ...
        # Must have graph_id for searching
    ...
    def _build_entity_context(self, entity: EntityNode) -> str:
        ...
        Includes:
        1. Entity's own edge info (facts)
        2. Detailed info of linked nodes
        ...
        # 3. Add detailed info of linked nodes
        if entity.related_nodes:
            ...
            if related_info:
                context_parts.append("### Linked Entity Information\n" + "\n".join(related_info))
    ...
    def _get_system_prompt(self, is_individual: bool) -> str:
        """Get system prompt"""
        base_prompt = "You are a social media user persona generation expert. Generate detailed, realistic personas for opinion simulation that maximally reproduce existing real-world conditions. Must return valid JSON format; no unescaped newline characters in string values. Use English."
        return base_prompt
    ...
    def _build_individual_persona_prompt(
        ...
        return f"""Generate a detailed social media user persona for this entity, maximally reproducing existing real-world conditions.
...
2. persona: Detailed persona description (~2000 words, plain text), including:
   ...
   - Personal memory (important part of persona: describe this individual's connection to events and their existing actions and reactions)
...
- Use English (gender must be English male/female)
...
"""
    ...
    def _build_group_persona_prompt(
        ...
        return f"""Generate a detailed social media account persona for this institution/group entity, maximally reproducing existing real-world conditions.
...
2. persona: Detailed account persona description (~2000 words, plain text), including:
   - Institution basic info (official name, nature, founding background, main functions)
   ...
   - Stance and attitude (official position on core topics, approach to controversy)
   - Special notes (represented group profile, operational habits)
   - Institutional memory (important part of persona: describe this institution's connection to events and its existing actions and reactions)
3. age: Fixed at 30 (virtual age for institution accounts)
4. gender: Fixed at "other" (institution accounts use "other" for non-individual)
5. mbti: MBTI type describing account style, e.g. ISTJ for formal and conservative
6. country: Country (in English, e.g. "China")
...
- persona must be a continuous prose description; do not use newline characters
- Use English (gender must be English "other")
- age must be integer 30, gender must be string "other"
- Institution account speech must match its identity and positioning"""
    ...
    def _generate_profile_rule_based(
        ...
        if entity_type_lower in ["student", "alumni"]:
            ...
            return {
                ...
                "mbti": "ISTJ",  # Institution style: formal and conservative
                "country": "China",
                "profession": "Media",
    ...
    def generate_profiles_from_entities(
        ...
        Args:
            ...
            graph_id: Graph ID for Zep context enrichment retrieval
            parallel_count: Number of parallel generation threads, default 5
            realtime_output_path: File path for real-time output (if provided, writes after each generated profile)
        ...
        def generate_single_profile(idx: int, entity: EntityNode) -> tuple:
            ...
            try:
                ...
                # Real-time output of generated persona to console and log
    ...
    def _print_generated_profile(self, entity_name: str, entity_type: str, profile: OasisAgentProfile):
        """Output generated persona to console in real-time (complete content, not truncated)"""
        separator = "-" * 70
    ...
    def _save_reddit_json(self, profiles: List[OasisAgentProfile], file_path: str):
        ...
        Uses the same format as to_reddit_format(), ensuring OASIS can read it correctly.
