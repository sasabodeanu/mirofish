    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': phase === 1, 'completed': phase > 1 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Using context, automatically calls tools to extract entities and relations from the knowledge graph, initializes simulation individuals, and endows them with unique behaviors and memories based on reality seeds
          </p>
      ...
      <div class="step-card" :class="{ 'active': phase === 2, 'completed': phase > 2 }">
        ...
        <div class="card-content">
          <p class="api-note">POST /api/simulation/prepare</p>
          <p class="description">
            The LLM intelligently configures world time flow, recommendation algorithms, active hours, posting frequency, event triggers, and other parameters based on simulation requirements and reality seeds
          </p>
          ...
          <div v-if="simulationConfig" class="config-detail-panel">
            ...
            <div class="config-block">
              <div class="config-grid">
                ...
                <div class="config-item">
                  <span class="config-item-label">Duration/Round</span>
      ...
      <div class="step-card" :class="{ 'active': phase === 4 }">
        ...
        <div class="card-content">
          ...
          <p class="description">Simulation environment ready. You can now start running the simulation.</p>
          ...
          <div v-if="simulationConfig && autoGeneratedRounds" class="rounds-config-section">
            <div class="rounds-header">
              <div class="header-left">
                ...
                <span class="section-desc">MiroFish auto-plans simulation of <span class="desc-highlight">{{ simulationConfig?.time_config?.total_simulation_hours || '-' }}</span> real hours; each round represents <span class="desc-highlight">{{ simulationConfig?.time_config?.minutes_per_round || '-' }}</span> real minutes</span>
              </div>
              ...
              <div v-if="useCustomRounds" class="rounds-content custom" key="custom">
                <div class="slider-display">
                  ...
                  <div class="slider-meta-info">
                    <span>Estimated time with 100 Agents: ~{{ Math.round(customMaxRounds * 0.6) }} minutes</span>
                  </div>
                </div>
                  ...
                  <div class="auto-content">
                    <div class="auto-meta-row">
                      <span class="duration-badge">
                        ...
                        Estimated time with 100 Agents: {{ Math.round(autoGeneratedRounds * 0.6) }} minutes
                      </span>
                    </div>
                    <div class="auto-desc">
                      <p class="highlight-tip" @click="useCustomRounds = true">For first-time runs, we strongly recommend switching to 'Custom Mode' to reduce rounds — this speeds up previewing and reduces error risk. ➝</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="modal-section" v-if="selectedProfile.persona">
            ...
            <div class="persona-dimensions">
              <div class="dimension-card">
                <span class="dim-title">Event Full Experience</span>
                <span class="dim-desc">Complete behavior trace in this event</span>
              </div>
              <div class="dimension-card">
...
// Log deduplication: track last logged info
...
watch(currentStage, (newStage) => {
  if (newStage === 'generate_agent_personas' || newStage === 'generating_profiles') {
    phase.value = 1
  } else if (newStage === 'generate_simulation_config' || newStage === 'generating_config') {
    phase.value = 2
  ...
  } else if (newStage === 'prepare_simulation_scripts' || newStage === 'copying_scripts') {
...
// Get username corresponding to agent_id
...
// Calculate total seed-linked topics across all personas
...
const handleStartSimulation = () => {
  ...
  if (useCustomRounds.value) {
    ...
    // User chose auto rounds: do not pass max_rounds param
  ...
  try {
    ...
    if (res.success && res.data) {
      if (res.data.already_prepared) {
        addLog('Existing completed preparation detected, using it directly')
...
const fetchConfigRealtime = async () => {
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      // Output config generation phase logs (avoid duplicates)
  ...
  try {
    ...
    if (res.success && res.data) {
      if (res.data.config_generated && res.data.config) {
        ...
        addLog('Config generating, start polling...')
        startConfigPolling()
      }
    }
  } catch (err) {
